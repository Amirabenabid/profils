...
<form action="updateprofil" method="post">
 ...
 <input type="text" name="idprofil" value="${profil.idprofil}"
readonly class="form-control"/>
 </div>
 <div class="form-group">
 <label class="control-label">Nom profil :</label>
 <input type="text" name="nomprofil" value="${profil.nomprofil}"
class="form-control"/>
 </div>
 <div class="form-group">
 <label class="control-label">Prix :</label>
 <input type="text" name="prixprofil" value="${profil.prixprofil}"
class="form-control"/>
 </div> 
 <div class="form-group">
 <label class="control-label"> Date creation :</label>
 <fmt:formatDate pattern="yyyy-MM-dd" value="${profil.dateCreation}" var="formatDate" />
...
<br/>
<br/>
<a href="listeprofil">Liste profils</a>
</div>
</body>
</html>